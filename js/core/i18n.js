...
const translations = {
  en: {
    ...
    createAccount: "Template Creation",
    logout: "Logout",
  ...
  failedAttemptsNotice: "{n}/5 failed login attempts. After 5 attempts the account will be locked.",
  unlockRequestBtn: "Unlock Request",
  unlockRequestMessage: "Unlock request submitted by user ({email}).",
  "unlock.requestSubmitted": "Unlock request submitted. The master account will be notified.",
  "unlock.requestSubmittedLocal": "Unlock request submitted (local). The master will see this in the local support list.",
  "unlock.requestFailed": "Failed to submit unlock request:",
  "account.lockedContactMaster": "This account is locked. Please contact the master to unlock it.",
  requestSent: "Request sent",
    ...
    failedUpdateClient: "Failed to update client information",
    nameRequired: "Name is required",
    specifications: "Specifications",
    addSpec: "Add Spec",
    noSpecifications: "No specifications assigned",
    removeSpec: "Remove Specification",
    specName: "Specification Name",
    specValues: "Values (comma separated)",
    specNamePlaceholder: "e.g., Size, Color, Style",
    specValuesPlaceholder: "e.g., Small, Medium, Large",
    specNameRequired: "Specification name is required",
    specValuesRequired: "At least one value is required",
    specAdded: "Specification added successfully",
    failedAddSpec: "Failed to add specification",
    confirmRemoveSpec: "Remove specification \"{spec}\"? This may affect generated designs.",
    specRemoved: "Specification removed",
    failedRemoveSpec: "Failed to remove specification",
    ...
    failedUpdateCredits: "Failed to update credits",
    confirmDeleteAccount: "Permanently delete this account? This action cannot be undone.",
  ...
  zh: {
    ...
    pleaseSignIn: "请先登录。",
  failedAttemptsNotice: "登录失败 {n}/5 次。达到 5 次后账户将被锁定。",
  unlockRequestBtn: "请求解锁",
  unlockRequestMessage: "用户已提交解锁请求（{email}）。",
  "unlock.requestSubmitted": "解锁请求已提交，主账号会收到通知。",
  "unlock.requestSubmittedLocal": "本地已提交解锁请求，主账号将在本地支持列表中看到。",
  "unlock.requestFailed": "提交解锁请求失败：",
  "account.lockedContactMaster": "该账户已被锁定，请联系主账号解锁。",
  requestSent: "已发送请求",
    ...
    saveChanges: "保存更改",
    clientUpdated: "客户信息更新成功",
    failedUpdateClient: "更新客户信息失败",
    nameRequired: "名称为必填项",
    specifications: "规格设置",
    addSpec: "添加规格",
    noSpecifications: "暂无规格设置",
    removeSpec: "移除规格",
    specName: "规格名称",
    specValues: "值（逗号分隔）",
    specNamePlaceholder: "例如：尺寸、颜色、风格",
    specValuesPlaceholder: "例如：小、中、大",
    specNameRequired: "规格名称为必填项",
    specValuesRequired: "至少需要一个值",
    specAdded: "规格添加成功",
    failedAddSpec: "添加规格失败",
    confirmRemoveSpec: "移除规格 \"{spec}\"？这可能影响已生成的设计。",
    specRemoved: "规格已移除",
    failedRemoveSpec: "移除规格失败",
    adjustCredits: "调整积分",
    setCredits: "设置积分",
    newBalance: "新余额",
    setBalance: "设置",
    ...
    failedUpdateCredits: "更新积分失败",
    confirmDeleteAccount: "永久删除此账户？此操作无法撤销。",
  ...
  yue: {
    ...
    // Client Management Edit
    editClient: "編輯客戶",
    editAccountInfo: "編輯賬戶資訊",
    saveChanges: "保存更改",
    clientUpdated: "客戶資訊更新成功",
    failedUpdateClient: "更新客戶資訊失敗",
    nameRequired: "名稱為必填項",
    specifications: "規格設定",
    addSpec: "新增規格",
    noSpecifications: "暫無規格設定",
    removeSpec: "移除規格",
    specName: "規格名稱",
    specValues: "值（逗號分隔）",
    specNamePlaceholder: "例如：尺寸、顏色、風格",
    specValuesPlaceholder: "例如：小、中、大",
    specNameRequired: "規格名稱為必填項",
    specValuesRequired: "至少需要一個值",
    specAdded: "規格新增成功",
    failedAddSpec: "新增規格失敗",
    confirmRemoveSpec: "移除規格 \"{spec}\"？這可能影響已生成的設計。",
    specRemoved: "規格已移除",
    failedRemoveSpec: "移除規格失敗",
    adjustCredits: "調整積分",
    setCredits: "設定積分",
    newBalance: "新餘額",
    setBalance: "設定",
    resetTo100: "重設為100",
    creditsUpdated: "積分已更新",
    failedUpdateCredits: "更新積分失敗",
    confirmDeleteAccount: "永久刪除此賬戶？此操作無法撤銷。",
    typeDeleteToConfirm: "輸入 DELETE 確認：",
    deleteCancelled: "刪除已取消",
    accountDeleted: "賬戶刪除成功",
    failedDeleteAccount: "刪除賬戶失敗",
    add: "+新增",
    deduct: "-扣除"
  }
};
